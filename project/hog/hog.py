...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for _ in range(num_rolls):
        ...
        if tmp == 1:
            has_one = True
        score += tmp
    return score if not has_one else 1
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    score = 3 * abs(player_score % 10 - opponent_score // 10 % 10)
    return max(score, 1)
    # END PROBLEM 2
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    max_rolls = 1
    ave = lambda num: make_averaged(roll_dice, samples_count)(num, dice)
    tmp_score_ave = ave(1)
    for i in range(2, 11):
        tmp = ave(i)
        if tmp_score_ave < tmp:
            max_rolls = i
            tmp_score_ave = tmp
    return max_rolls
    # END PROBLEM 9
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    get_score = sus_update(0, score, opponent_score) - score
    return 0 if get_score >= threshold else num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return (score + opponent_score) % 11  # Remove this line once implemented.
    # END PROBLEM 12
